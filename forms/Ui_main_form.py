...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.curr_position = QtWidgets.QSpinBox(self.gb_)
        self.curr_position.setReadOnly(True)
        self.curr_position.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.curr_position.setMinimum(-100)
        self.curr_position.setMaximum(300)
        self.curr_position.setProperty("value", 100)
